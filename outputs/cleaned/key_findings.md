...
## Top 5 Findings
1. **Deployment breakdown risk is concentrated at one site.**
   - Evidence: GF Berlin shows 5 disruption events, 13.0 delay-days, and $136,000 impact.
2. **Project controls failed most in a specific cost category.**
   - Evidence: Highest overrun is Berlin / HVAC Systems: $560,000 (12.0%).
3. **Adoption breakdown is visible through blocked users.**
   - Evidence: Worst average blocked-user ratio is Berlin at 78.6%.
...
2. Front-load interventions on categories/teams mirroring top historical overruns and unresolved pain-point clusters; define SLA-based escalation for high-priority items.
3. Harden reporting inputs before go-live: mandatory templates for status, impacts, and closure states to reduce missing data and improve decision confidence.